...
# precision tp / (tp + fp)
precision = precision_score(pred , y_test, labels=labels,pos_label=1,average='macro')
print('[INFO] Gradient Boosting Precision: %f' % precision)
# recall: tp / (tp + fn)
recall = recall_score(pred , y_test, labels=labels,pos_label=1,average='macro')
print('[INFO] Gradient Boosting Recall: %f' % recall)
# f1: 2 tp / (2 tp + fp + fn)
f1 = f1_score(pred , y_test, labels=labels,pos_label=1,average='macro')
